...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="ANALOG_IO" URI="http://resources/4.0.10/app/ANALOG_IO/0" description="Configures a port pin to use as analog input/output and digital input." version="4.0.10" minDaveVersion="4.0.0" instanceLabel="Group_0_Channel_0_in" appLabel="">
  ...
  <hwResources name="pin" URI="http://resources/4.0.10/app/ANALOG_IO/0/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/31" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.10/app/ANALOG_IO/0/http://resources/4.0.10/app/ANALOG_IO/0/vs_analog_io_pad_pin/http://resources/4.0.6/app/VADC_GROUP_CONFIG/0/vs_group_vadc_ch0_gch" sourceSignal="pin" targetSignal="ch0_input" srcVirtualSignal="//@virtualSignals.0">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../VADC_GROUP_CONFIG/v4_0_6/VADC_GROUP_CONFIG_0.app#//@virtualSignals.9"/>
    <targetVirtualSignal href="../../VADC_GROUP_CONFIG/v4_0_6/VADC_GROUP_CONFIG_0.app#//@virtualSignals.9"/>
  </connections>
</ResourceModel:App>
